...
namespace FotoStudio
{
	public class sql : MySQL
	{
		...
		public void insertarRegistroNuevo(string rfc, string nombrete, string apellidote, string domiciliote, string numerote, string ninter, string colon, string telefonote, string celular){
			this.abrirConexion();
			string sql = "INSERT INTO `clientes` (`rfc`,`nombre`, `apellido`, `domicilio`,`numero`,`interior`,`colonia`,`telefono`,`celular`) VALUES ('"+rfc+"','" + nombrete + "', '" + apellidote + "','" + domiciliote + "','"+ numerote +"','"+ ninter +"', '" + colon + "','"+telefonote+ "','"+celular +"')";
